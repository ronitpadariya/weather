...
import com.github.ronit.weather.ui.dummy.DummyContent
...
class WeatherListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (findViewById<NestedScrollView>(R.id.weather_detail_container) != null) {
        ...
        setupRecyclerView(findViewById(R.id.weather_list))
    }
    ...
    class SimpleItemRecyclerViewAdapter(private val parentActivity: WeatherListActivity,
